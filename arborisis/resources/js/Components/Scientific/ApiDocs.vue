...
<template>
    <div class="glass-card p-6">
        ...
        <p class="text-sm text-arbor-sage mb-6">
        ...
        <div class="mt-6 p-4 rounded-xl bg-arbor-deep/60 border border-arbor-glass-border">
            <p class="text-xs text-arbor-sage font-mono mb-2">Exemple de requête :</p>
            <code class="block text-arbor-emerald font-mono text-sm">
                curl -H "Accept: application/json" \
                <br>&nbsp;&nbsp;https://arborisis.fr/api/scientific-stats/global
            </code>
        </div>
    </div>
</template>
