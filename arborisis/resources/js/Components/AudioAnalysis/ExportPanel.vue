    ...
    <div class="glass-card p-6">
        ...
        <div class="grid grid-cols-2 gap-3">
            <button @click="exportFormat('json')"
                class="px-4 py-3 rounded-xl bg-arbor-glass border border-arbor-glass-border text-arbor-sage text-sm hover:text-arbor-cream hover:bg-white/10 transition-all flex items-center justify-center gap-2">
