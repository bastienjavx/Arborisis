            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="hidden md:flex items-center gap-6">
                        ...
                        <Link href="/<redacted>-map" class="text-sm text-arbor-sage hover:text-arbor-cream transition-colors">
                            Carte communauté
                        </Link>
            ...
            >
                <div class="space-y-1 pb-3 pt-2 px-4">
                    ...
                    <Link
                        href="/<redacted>-map"
                        class="block px-3 py-2 rounded-lg text-arbor-sage hover:text-arbor-cream hover:bg-arbor-glass transition-colors"
                        :class="route().current('<redacted>-map.index') ? 'text-arbor-emerald bg-arbor-emerald/10' : ''"
                    >
                        Carte communauté
                    </Link>
                    <Link
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm text-arbor-sage">
                            ...
                            <li><Link href="/<redacted>-map" class="hover:text-arbor-emerald transition-colors">Carte communauté</Link></li>
