...
<template>
    <Head :title="`Abonnements de ${user.name}`" />
    <GuestLayout>
            ...
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mb-8">
                    ...
                    <h1 class="font-display text-2xl font-bold text-arbor-cream">
                        Abonnements de {{ user.name }}
                    </h1>
                    <p class="text-arbor-sage text-sm mt-1">{{ list.total }} personne{{ list.total > 1 ? 's' : '' }}</p>
                </div>
                ...
                <div v-else class="text-center py-12">
                    <p class="text-arbor-sage">Aucun abonnement pour le moment.</p>
                </div>
