...
import { t as _sfc_main$2 } from "./Breadcrumb-Cl9EPnkX.js";
import { t as _sfc_main$3 } from "./FollowButton-BRPBIklU.js";
			...
			_push(ssrRenderComponent(_sfc_main$1, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`</div><div class="flex-1 text-center sm:text-left"${_scopeId}><div class="flex items-center justify-center sm:justify-start gap-2 mb-2"${_scopeId}><h1 class="font-display text-2xl sm:text-3xl font-bold text-arbor-cream"${_scopeId}>${ssrInterpolate(__props.creator.name)}</h1>`);
						...
						_push(`<div class="flex flex-wrap justify-center sm:justify-start gap-4 text-sm text-arbor-sage mb-4"${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<span class="font-semibold text-arbor-cream transition-transform group-hover:scale-110"${_scopeId}>${ssrInterpolate(__props.stats.followers_count)}</span><span${_scopeId}>abonné${ssrInterpolate(__props.stats.followers_count > 1 ? "s" : "")}</span>`);
								else return [createVNode("span", { class: "font-semibold text-arbor-cream transition-transform group-hover:scale-110" }, toDisplayString(__props.stats.followers_count), 1), createVNode("span", null, "abonné" + toDisplayString(__props.stats.followers_count > 1 ? "s" : ""), 1)];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(ssrRenderComponent(unref(Link), {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<span class="font-semibold text-arbor-cream transition-transform group-hover:scale-110"${_scopeId}>${ssrInterpolate(__props.stats.following_count)}</span><span${_scopeId}>abonnements</span>`);
								else return [createVNode("span", { class: "font-semibold text-arbor-cream transition-transform group-hover:scale-110" }, toDisplayString(__props.stats.following_count), 1), createVNode("span", null, "abonnements")];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(ssrRenderComponent(unref(Link), {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<span class="font-semibold text-arbor-cream transition-transform group-hover:scale-110"${_scopeId}>${ssrInterpolate(__props.stats.friends_count ?? 0)}</span><span${_scopeId}>ami${ssrInterpolate((__props.stats.friends_count ?? 0) > 1 ? "s" : "")}</span>`);
								else return [createVNode("span", { class: "font-semibold text-arbor-cream transition-transform group-hover:scale-110" }, toDisplayString(__props.stats.friends_count ?? 0), 1), createVNode("span", null, "ami" + toDisplayString((__props.stats.friends_count ?? 0) > 1 ? "s" : ""), 1)];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(`<div class="flex items-center gap-1 group cursor-default"${_scopeId}><span class="font-semibold text-arbor-cream transition-transform group-hover:scale-110"${_scopeId}>${ssrInterpolate(__props.stats.sounds_count)}</span><span${_scopeId}>son${ssrInterpolate(__props.stats.sounds_count > 1 ? "s" : "")}</span></div><div class="flex items-center gap-1 group cursor-default"${_scopeId}><span class="font-semibold text-arbor-cream transition-transform group-hover:scale-110"${_scopeId}>${ssrInterpolate(__props.stats.total_plays)}</span><span${_scopeId}>écoutes</span></div></div>`);
						...
						if (__props.sounds.data.length > 0) {
							...
							ssrRenderList(__props.sounds.data, (sound, index) => {
								_push(ssrRenderComponent(unref(Link), {
									...
									class: "glass-card overflow-hidden hover:bg-white/10 transition-transform duration-300 group hover-lift",
						...
						createVNode("div", { class: "glass-card p-6 sm:p-8 mb-8 relative overflow-hidden" }, [createVNode("div", { class: "absolute inset-0 bg-gradient-to-br from-arbor-moss/5 via-transparent to-arbor-emerald/5 pointer-events-none" }), createVNode("div", { class: "relative z-10 flex flex-col sm:flex-row items-center sm:items-start gap-6" }, [createVNode("div", { class: "w-24 h-24 rounded-full bg-arbor-moss/30 flex items-center justify-center shrink-0 overflow-hidden ring-4 ring-arbor-glass-border/50" }, [__props.avatarUrl ? (openBlock(), createBlock("img", {
							...
							createVNode("div", { class: "flex items-center justify-center sm:justify-start gap-2 mb-2" }, [createVNode("h1", { class: "font-display text-2xl sm:text-3xl font-bold text-arbor-cream" }, toDisplayString(__props.creator.name), 1), __props.isFriend ? (openBlock(), createBlock("span", {
								key: 0,
							...
							createVNode("div", { class: "flex flex-wrap justify-center sm:justify-start gap-4 text-sm text-arbor-sage mb-4" }, [
								createVNode(unref(Link), {
									...
									default: withCtx(() => [createVNode("span", { class: "font-semibold text-arbor-cream transition-transform group-hover:scale-110" }, toDisplayString(__props.stats.followers_count), 1), createVNode("span", null, "abonné" + toDisplayString(__props.stats.followers_count > 1 ? "s" : ""), 1)]),
									_: 1
								}, 8, ["href"]),
								createVNode(unref(Link), {
									href: _ctx.route("users.following", __props.creator.slug),
									...
									default: withCtx(() => [createVNode("span", { class: "font-semibold text-arbor-cream transition-transform group-hover:scale-110" }, toDisplayString(__props.stats.following_count), 1), createVNode("span", null, "abonnements")]),
									_: 1
								}, 8, ["href"]),
								createVNode(unref(Link), {
									href: _ctx.route("users.friends", __props.creator.slug),
									...
									default: withCtx(() => [createVNode("span", { class: "font-semibold text-arbor-cream transition-transform group-hover:scale-110" }, toDisplayString(__props.stats.friends_count ?? 0), 1), createVNode("span", null, "ami" + toDisplayString((__props.stats.friends_count ?? 0) > 1 ? "s" : ""), 1)]),
									_: 1
								}, 8, ["href"]),
