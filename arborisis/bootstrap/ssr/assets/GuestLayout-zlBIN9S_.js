import { n as ApplicationLogo_default, t as _sfc_main$3 } from "./PushNotificationToggle-BYVGcMEE.js";
import { Link, useForm } from "@inertiajs/vue3";
import { computed, createTextVNode, createVNode, mergeProps, ref, toDisplayString, unref, useSSRContext, watch, withCtx } from "vue";
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(Link), {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(ssrRenderComponent(ApplicationLogo_default, { class: "h-12 w-auto shrink-0" }, null, _parent, _scopeId));
					else return [createVNode(ApplicationLogo_default, { class: "h-12 w-auto shrink-0" })];
				}),
				_: 1
			}, _parent));
			...
			_push(ssrRenderComponent(unref(Link), {
				href: "/<redacted>-map",
				class: ["block px-3 py-2 rounded-lg text-arbor-sage hover:text-arbor-cream hover:bg-arbor-glass transition-colors", _ctx.route().current("<redacted>-map.index") ? "text-arbor-emerald bg-arbor-emerald/10" : ""]
			}, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(` Carte communauté `);
					else return [createTextVNode(" Carte communauté ")];
			...
			_push(ssrRenderComponent(unref(Link), {
				href: "/blog",
				class: ["block px-3 py-2 rounded-lg text-arbor-sage hover:text-arbor-cream hover:bg-arbor-glass transition-colors", _ctx.route().current("blog.*") ? "text-arbor-emerald bg-arbor-emerald/10" : ""]
			}, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(` Chroniques `);
					else return [createTextVNode(" Chroniques ")];
			...
			_push(`<footer class="border-t border-arbor-glass-border bg-arbor-deep"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12"><div class="grid grid-cols-1 md:grid-cols-4 gap-8"><div class="md:col-span-2"><div class="flex items-center mb-4">`);
			_push(ssrRenderComponent(ApplicationLogo_default, { class: "h-16 w-auto shrink-0" }, null, _parent));
