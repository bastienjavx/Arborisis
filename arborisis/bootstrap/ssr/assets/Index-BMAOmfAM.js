...
var _sfc_main = {
	...
	setup(__props) {
		...
		const DataTable = defineAsyncComponent(() => import("./DataTable-DiHo5Hak.js"));
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_sfc_main$2, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="min-h-screen bg-arbor-night" data-v-1be95af0${_scopeId}><div class="relative overflow-hidden" data-v-1be95af0${_scopeId}><div class="absolute inset-0 bg-gradient-to-b from-arbor-moss/10 via-transparent to-transparent pointer-events-none" data-v-1be95af0${_scopeId}></div><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-10" data-v-1be95af0${_scopeId}><div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4" data-v-1be95af0${_scopeId}><div data-v-1be95af0${_scopeId}><div class="flex items-center gap-2 mb-3" data-v-1be95af0${_scopeId}><span class="inline-block w-2 h-2 rounded-full bg-arbor-emerald animate-pulse" data-v-1be95af0${_scopeId}></span><span class="text-xs font-medium text-arbor-emerald uppercase tracking-widest" data-v-1be95af0${_scopeId}>Open Data</span></div><h1 class="font-display text-4xl md:text-5xl font-bold text-arbor-cream leading-tight" data-v-1be95af0${_scopeId}> Données scientifiques </h1><p class="mt-3 text-arbor-sage text-lg max-w-2xl" data-v-1be95af0${_scopeId}> Statistiques agrégées et anonymisées de la plateforme Arborisis, destinées à la recherche, la data science et la conservation. </p></div><div class="text-right hidden md:block" data-v-1be95af0${_scopeId}><p class="text-xs text-arbor-sage/70 font-mono" data-v-1be95af0${_scopeId}> Mis à jour : ${ssrInterpolate((/* @__PURE__ */ new Date()).toLocaleDateString("fr-FR"))}</p><p class="text-xs text-arbor-sage/70 font-mono" data-v-1be95af0${_scopeId}>${ssrInterpolate(props.stats.total_sounds?.toLocaleString("fr-FR"))} sons indexés </p></div></div></div></div><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8" data-v-1be95af0${_scopeId}><div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4" data-v-1be95af0${_scopeId}>`);
						...
						_push(`</div></div><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-4" data-v-1be95af0${_scopeId}><div class="flex flex-wrap gap-1 p-1 rounded-xl bg-arbor-deep/60 border border-arbor-glass-border backdrop-blur-sm" data-v-1be95af0${_scopeId}><!--[-->`);
						ssrRenderList(tabs, (tab) => {
							_push(`<button class="${ssrRenderClass(["px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200", activeTab.value === tab.key ? "bg-arbor-moss/20 text-arbor-emerald border border-arbor-emerald/30" : "text-arbor-sage hover:text-arbor-cream hover:bg-arbor-glass/30"])}" data-v-1be95af0${_scopeId}>${ssrInterpolate(tab.label)}</button>`);
						});
						_push(`<!--]--></div></div><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20" data-v-1be95af0${_scopeId}>`);
						if (activeTab.value === "overview") {
							_push(`<div class="space-y-6 animate-fade-in" data-v-1be95af0${_scopeId}><div class="grid grid-cols-1 lg:grid-cols-2 gap-6" data-v-1be95af0${_scopeId}>`);
							...
							_push(`<div class="grid grid-cols-1 lg:grid-cols-2 gap-6" data-v-1be95af0${_scopeId}><div class="glass-card p-6" data-v-1be95af0${_scopeId}><h3 class="font-display text-xl font-semibold text-arbor-cream mb-4" data-v-1be95af0${_scopeId}>Lieux les plus enregistrés</h3><div class="space-y-2" data-v-1be95af0${_scopeId}><!--[-->`);
							ssrRenderList(props.topLocations.slice(0, 10), (loc, i) => {
								_push(`<div class="flex items-center justify-between p-2.5 rounded-lg bg-arbor-deep/50 border border-arbor-glass-border/50 hover:border-arbor-emerald/30 transition-colors" data-v-1be95af0${_scopeId}><div class="flex items-center gap-3" data-v-1be95af0${_scopeId}><span class="text-xs font-mono text-arbor-sage w-5" data-v-1be95af0${_scopeId}>${ssrInterpolate(i + 1)}</span><span class="text-sm text-arbor-cream" data-v-1be95af0${_scopeId}>${ssrInterpolate(loc.name)}</span></div><span class="text-xs font-mono text-arbor-emerald" data-v-1be95af0${_scopeId}>${ssrInterpolate(loc.count)}</span></div>`);
							});
							_push(`<!--]--></div></div>`);
						...
						if (activeTab.value === "geo") {
							_push(`<div class="space-y-6 animate-fade-in" data-v-1be95af0${_scopeId}>`);
							_push(ssrRenderComponent(unref(GeoHeatmap), { points: props.geoHeatmap }, null, _parent, _scopeId));
							_push(`<div class="grid grid-cols-1 lg:grid-cols-3 gap-6" data-v-1be95af0${_scopeId}><div class="glass-card p-6 lg:col-span-2" data-v-1be95af0${_scopeId}><h3 class="font-display text-xl font-semibold text-arbor-cream mb-4" data-v-1be95af0${_scopeId}>Densité par région</h3><div class="space-y-2 max-h-[400px] overflow-y-auto custom-scrollbar pr-2" data-v-1be95af0${_scopeId}><!--[-->`);
							ssrRenderList(props.geoHeatmap.slice(0, 50), (loc, i) => {
								_push(`<div class="flex items-center justify-between p-2 rounded-lg bg-arbor-deep/30" data-v-1be95af0${_scopeId}><div class="flex items-center gap-3" data-v-1be95af0${_scopeId}><span class="text-xs font-mono text-arbor-sage" data-v-1be95af0${_scopeId}>${ssrInterpolate(i + 1)}</span><span class="text-sm text-arbor-cream font-mono" data-v-1be95af0${_scopeId}>${ssrInterpolate(loc.lat.toFixed(1))}, ${ssrInterpolate(loc.lng.toFixed(1))}</span><span class="text-xs text-arbor-sage/70 truncate max-w-[200px]" data-v-1be95af0${_scopeId}>${ssrInterpolate(loc.categories)}</span></div><span class="text-xs font-mono text-arbor-emerald" data-v-1be95af0${_scopeId}>${ssrInterpolate(loc.count)}</span></div>`);
							});
							_push(`<!--]--></div></div><div class="glass-card p-6" data-v-1be95af0${_scopeId}><h3 class="font-display text-xl font-semibold text-arbor-cream mb-4" data-v-1be95af0${_scopeId}>Méthodologie</h3><div class="space-y-3 text-sm text-arbor-sage" data-v-1be95af0${_scopeId}><p data-v-1be95af0${_scopeId}>Les coordonnées sont agrégées par cellules de <strong class="text-arbor-cream" data-v-1be95af0${_scopeId}>0.1°</strong> (environ 11 km) pour préserver la confidentialité des lieux sensibles.</p><p data-v-1be95af0${_scopeId}>Les coordonnées exactes des enregistrements ne sont jamais exposées publiquement.</p><p data-v-1be95af0${_scopeId}>Seuls les enregistrements <strong class="text-arbor-cream" data-v-1be95af0${_scopeId}>publics</strong> et <strong class="text-arbor-cream" data-v-1be95af0${_scopeId}>publiés</strong> sont comptabilisés.</p></div></div></div></div>`);
						} else _push(`<!---->`);
						if (activeTab.value === "audio") {
							_push(`<div class="space-y-6 animate-fade-in" data-v-1be95af0${_scopeId}><div class="grid grid-cols-1 lg:grid-cols-4 gap-4" data-v-1be95af0${_scopeId}><div class="glass-card p-5" data-v-1be95af0${_scopeId}><p class="text-xs uppercase tracking-wider text-arbor-sage" data-v-1be95af0${_scopeId}>Analyses terminées</p><p class="mt-2 font-display text-3xl font-bold text-arbor-cream" data-v-1be95af0${_scopeId}>${ssrInterpolate(audioSummary.value.completedAnalyses.toLocaleString("fr-FR"))}</p><p class="mt-1 text-xs text-arbor-sage" data-v-1be95af0${_scopeId}>sur ${ssrInterpolate(audioSummary.value.totalAnalyses.toLocaleString("fr-FR"))} analyses créées</p></div><div class="glass-card p-5" data-v-1be95af0${_scopeId}><p class="text-xs uppercase tracking-wider text-arbor-sage" data-v-1be95af0${_scopeId}>Couverture dataset</p><p class="mt-2 font-display text-3xl font-bold text-arbor-emerald" data-v-1be95af0${_scopeId}>${ssrInterpolate(audioSummary.value.coverage)}%</p><div class="mt-3 h-1.5 rounded-full bg-arbor-deep overflow-hidden" data-v-1be95af0${_scopeId}><div class="h-full rounded-full bg-arbor-emerald" style="${ssrRenderStyle({ width: `${Math.min(audioSummary.value.coverage, 100)}%` })}" data-v-1be95af0${_scopeId}></div></div></div><div class="glass-card p-5" data-v-1be95af0${_scopeId}><p class="text-xs uppercase tracking-wider text-arbor-sage" data-v-1be95af0${_scopeId}>Features publiées</p><p class="mt-2 font-display text-3xl font-bold text-arbor-cream" data-v-1be95af0${_scopeId}>${ssrInterpolate(audioSummary.value.featureCount)}</p><p class="mt-1 text-xs text-arbor-sage" data-v-1be95af0${_scopeId}>${ssrInterpolate(audioSummary.value.distributionCount)} distributions disponibles</p></div><div class="glass-card p-5" data-v-1be95af0${_scopeId}><p class="text-xs uppercase tracking-wider text-arbor-sage" data-v-1be95af0${_scopeId}>File d&#39;attente</p><p class="mt-2 font-display text-3xl font-bold text-arbor-amber" data-v-1be95af0${_scopeId}>${ssrInterpolate(audioSummary.value.pendingAnalyses.toLocaleString("fr-FR"))}</p><p class="mt-1 text-xs text-arbor-sage" data-v-1be95af0${_scopeId}>analyses non finalisées</p></div></div>`);
							if (audioSummary.value.hasFeatures) {
								_push(`<div class="space-y-6" data-v-1be95af0${_scopeId}>`);
								...
								_push(`</div>`);
							} else _push(`<div class="glass-card p-8 overflow-hidden relative" data-v-1be95af0${_scopeId}><div class="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-arbor-emerald/60 to-transparent" data-v-1be95af0${_scopeId}></div><div class="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-8 items-center" data-v-1be95af0${_scopeId}><div data-v-1be95af0${_scopeId}><p class="text-xs uppercase tracking-widest text-arbor-emerald mb-3" data-v-1be95af0${_scopeId}>Analyse audio</p><h3 class="font-display text-2xl font-semibold text-arbor-cream mb-3" data-v-1be95af0${_scopeId}>Aucune feature exploitable n&#39;est encore publiée</h3><p class="text-sm leading-relaxed text-arbor-sage" data-v-1be95af0${_scopeId}> La page reste prête pour les résultats du pipeline. Dès que les analyses auront des métriques dans <code class="px-1.5 py-0.5 rounded bg-arbor-deep text-arbor-cream" data-v-1be95af0${_scopeId}>features_json</code>, les graphiques, histogrammes et statistiques descriptives apparaîtront automatiquement. </p></div><div class="rounded-xl border border-arbor-glass-border bg-arbor-deep/50 p-5" data-v-1be95af0${_scopeId}><p class="text-xs uppercase tracking-wider text-arbor-sage mb-4" data-v-1be95af0${_scopeId}>À vérifier côté pipeline</p><div class="space-y-3" data-v-1be95af0${_scopeId}><div class="flex items-start gap-3" data-v-1be95af0${_scopeId}><span class="mt-1 h-2 w-2 rounded-full bg-arbor-emerald" data-v-1be95af0${_scopeId}></span><p class="text-sm text-arbor-sage" data-v-1be95af0${_scopeId}>Les analyses sont marquées comme traitées via <code class="text-arbor-cream" data-v-1be95af0${_scopeId}>processed_at</code>.</p></div><div class="flex items-start gap-3" data-v-1be95af0${_scopeId}><span class="mt-1 h-2 w-2 rounded-full bg-arbor-amber" data-v-1be95af0${_scopeId}></span><p class="text-sm text-arbor-sage" data-v-1be95af0${_scopeId}>Le JSON contient les chemins attendus : temporal, spectral, stats et values.</p></div><div class="flex items-start gap-3" data-v-1be95af0${_scopeId}><span class="mt-1 h-2 w-2 rounded-full bg-arbor-moss" data-v-1be95af0${_scopeId}></span><p class="text-sm text-arbor-sage" data-v-1be95af0${_scopeId}>Les sons associés sont publics et publiés, sinon ils restent exclus.</p></div></div></div></div></div>`);
							_push(`<div class="grid grid-cols-1 lg:grid-cols-2 gap-6" data-v-1be95af0${_scopeId}><div class="glass-card p-6" data-v-1be95af0${_scopeId}><h3 class="font-display text-xl font-semibold text-arbor-cream mb-4" data-v-1be95af0${_scopeId}>Pipeline d&#39;analyse</h3><div class="space-y-4" data-v-1be95af0${_scopeId}><!--[-->`);
							ssrRenderList(pipelineSteps, (step, index) => {
								_push(`<div class="flex gap-4 rounded-xl border border-arbor-glass-border/70 bg-arbor-deep/35 p-4" data-v-1be95af0${_scopeId}><div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-arbor-emerald/10 text-xs font-mono text-arbor-emerald" data-v-1be95af0${_scopeId}>${ssrInterpolate(index + 1)}</div><div data-v-1be95af0${_scopeId}><h4 class="text-sm font-semibold text-arbor-cream" data-v-1be95af0${_scopeId}>${ssrInterpolate(step.title)}</h4><p class="mt-1 text-sm leading-relaxed text-arbor-sage" data-v-1be95af0${_scopeId}>${ssrInterpolate(step.desc)}</p></div></div>`);
							});
							_push(`<!--]--></div></div><div class="glass-card p-6" data-v-1be95af0${_scopeId}><h3 class="font-display text-xl font-semibold text-arbor-cream mb-4" data-v-1be95af0${_scopeId}>Qualité &amp; confidentialité</h3><div class="space-y-3" data-v-1be95af0${_scopeId}><!--[-->`);
							ssrRenderList(qualityChecks, (check) => {
								_push(`<div class="flex items-start gap-3 rounded-lg bg-arbor-deep/35 px-3 py-2.5" data-v-1be95af0${_scopeId}><span class="mt-1 h-2 w-2 rounded-full bg-arbor-emerald" data-v-1be95af0${_scopeId}></span><p class="text-sm text-arbor-sage" data-v-1be95af0${_scopeId}>${ssrInterpolate(check)}</p></div>`);
							});
							_push(`<!--]--></div><div class="mt-5 rounded-xl border border-arbor-amber/25 bg-arbor-amber/10 p-4" data-v-1be95af0${_scopeId}><p class="text-sm leading-relaxed text-arbor-sage" data-v-1be95af0${_scopeId}> Les métriques audio sont des indicateurs descriptifs. Elles ne remplacent pas une annotation naturaliste ni une validation experte des espèces ou habitats. </p></div></div></div><div class="glass-card p-6" data-v-1be95af0${_scopeId}><h3 class="font-display text-xl font-semibold text-arbor-cream mb-4" data-v-1be95af0${_scopeId}>Statistiques descriptives — Features audio</h3><div class="overflow-x-auto" data-v-1be95af0${_scopeId}><table class="w-full text-sm text-left" data-v-1be95af0${_scopeId}><thead class="text-xs text-arbor-sage uppercase border-b border-arbor-glass-border" data-v-1be95af0${_scopeId}><tr data-v-1be95af0${_scopeId}><th class="px-4 py-3" data-v-1be95af0${_scopeId}>Feature</th><th class="px-4 py-3" data-v-1be95af0${_scopeId}>N</th><th class="px-4 py-3" data-v-1be95af0${_scopeId}>Moyenne</th><th class="px-4 py-3" data-v-1be95af0${_scopeId}>Médiane</th><th class="px-4 py-3" data-v-1be95af0${_scopeId}>Écart-type</th><th class="px-4 py-3" data-v-1be95af0${_scopeId}>Min</th><th class="px-4 py-3" data-v-1be95af0${_scopeId}>Max</th></tr></thead><tbody data-v-1be95af0${_scopeId}><!--[-->`);
							ssrRenderList(audioFeatureRows.value, (row) => {
								_push(`<tr class="border-b border-arbor-glass-border/50 hover:bg-arbor-glass/20 transition-colors" data-v-1be95af0${_scopeId}><td class="px-4 py-3" data-v-1be95af0${_scopeId}><div class="text-arbor-cream font-medium" data-v-1be95af0${_scopeId}>${ssrInterpolate(row.label)}</div><div class="mt-1 max-w-sm text-xs text-arbor-sage/70" data-v-1be95af0${_scopeId}>${ssrInterpolate(row.description)}</div></td><td class="px-4 py-3 text-arbor-sage font-mono" data-v-1be95af0${_scopeId}>${ssrInterpolate(row.stats.count)}</td><td class="px-4 py-3 text-arbor-emerald font-mono" data-v-1be95af0${_scopeId}>${ssrInterpolate(Number(row.stats.mean).toExponential(3))}</td><td class="px-4 py-3 text-arbor-sage font-mono" data-v-1be95af0${_scopeId}>${ssrInterpolate(Number(row.stats.median).toExponential(3))}</td><td class="px-4 py-3 text-arbor-sage font-mono" data-v-1be95af0${_scopeId}>${ssrInterpolate(Number(row.stats.std).toExponential(3))}</td><td class="px-4 py-3 text-arbor-sage font-mono" data-v-1be95af0${_scopeId}>${ssrInterpolate(Number(row.stats.min).toExponential(3))}</td><td class="px-4 py-3 text-arbor-sage font-mono" data-v-1be95af0${_scopeId}>${ssrInterpolate(Number(row.stats.max).toExponential(3))}</td></tr>`);
							});
							_push(`<!--]-->`);
							if (audioFeatureRows.value.length === 0) _push(`<tr data-v-1be95af0${_scopeId}><td colspan="7" class="px-4 py-8 text-center text-arbor-sage" data-v-1be95af0${_scopeId}> Aucune statistique descriptive disponible pour le moment. </td></tr>`);
							else _push(`<!---->`);
							_push(`</tbody></table></div></div><div class="glass-card p-6" data-v-1be95af0${_scopeId}><h3 class="font-display text-xl font-semibold text-arbor-cream mb-4" data-v-1be95af0${_scopeId}>Dictionnaire des features</h3><div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3" data-v-1be95af0${_scopeId}><!--[-->`);
							ssrRenderList(featureDescriptions, (description, key) => {
								_push(`<div class="rounded-xl border border-arbor-glass-border bg-arbor-deep/35 p-4" data-v-1be95af0${_scopeId}><code class="text-xs text-arbor-emerald" data-v-1be95af0${_scopeId}>${ssrInterpolate(key)}</code><h4 class="mt-2 text-sm font-semibold text-arbor-cream" data-v-1be95af0${_scopeId}>${ssrInterpolate(featureLabels[key] ?? key)}</h4><p class="mt-1 text-sm leading-relaxed text-arbor-sage" data-v-1be95af0${_scopeId}>${ssrInterpolate(description)}</p></div>`);
							});
							_push(`<!--]--></div></div></div>`);
						} else _push(`<!---->`);
						if (activeTab.value === "data") {
							...
							_push(`<div class="glass-card p-6" data-v-1be95af0${_scopeId}><h3 class="font-display text-xl font-semibold text-arbor-cream mb-2" data-v-1be95af0${_scopeId}>Licence d&#39;utilisation des données</h3><p class="text-sm text-arbor-sage" data-v-1be95af0${_scopeId}> Les données exposées sur cette page et via l&#39;API sont agrégées et anonymisées. Elles sont mises à disposition à des fins de recherche scientifique, d&#39;éducation et de conservation. Merci de citer <strong class="text-arbor-cream" data-v-1be95af0${_scopeId}>Arborisis</strong> dans vos publications. Pour un accès à des données plus granulaires ou spécifiques, contactez l&#39;équipe. </p></div></div>`);
						} else _push(`<!---->`);
...
var Index_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-1be95af0"]]);
//#endregion
