import { t as _sfc_main$6 } from "./AuthenticatedLayout-BYUVvhyG.js";
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						ssrRenderList(tabs, (tab) => {
							_push(`<button class="${ssrRenderClass([activeTab.value === tab.id ? "text-arbor-emerald" : "text-arbor-sage hover:text-arbor-cream", "px-4 py-3 text-sm font-medium transition-colors relative"])}"${_scopeId}>${ssrInterpolate(tab.label)} `);
							if (activeTab.value === tab.id) _push(`<span class="absolute bottom-0 left-0 right-0 h-0.5 bg-arbor-emerald rounded-full"${_scopeId}></span>`);
							else _push(`<!---->`);
							_push(`</button>`);
						});
						...
						createVNode("section", { class: "pb-8 section-padding" }, [createVNode("div", { class: "max-w-7xl mx-auto" }, [createVNode("div", { class: "flex items-center gap-1 border-b border-arbor-glass-border" }, [(openBlock(), createBlock(Fragment, null, renderList(tabs, (tab) => {
							return createVNode("button", {
								...
								class: ["px-4 py-3 text-sm font-medium transition-colors relative", activeTab.value === tab.id ? "text-arbor-emerald" : "text-arbor-sage hover:text-arbor-cream"]
