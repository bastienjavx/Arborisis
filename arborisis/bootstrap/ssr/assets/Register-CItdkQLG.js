			...
			_push(ssrRenderComponent(_sfc_main$1, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						class: ["glass-card-glow p-8 sm:p-10 relative overflow-hidden", mounted.value ? "opacity-100 scale-100" : "opacity-0 scale-95"],
						...
						createVNode("div", { class: "organic-blob w-40 h-40 bg-arbor-emerald/10 -top-10 -right-10" }),
						createVNode("div", {
