import { n as ApplicationLogo_default, t as _sfc_main$5 } from "./PushNotificationToggle-B6D0DzcS.js";
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(Link), {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(ApplicationLogo_default, { class: "block h-8 w-8 text-arbor-emerald shrink-0" }, null, _parent, _scopeId));
						_push(`<span class="font-display text-lg font-semibold hidden sm:block"${_scopeId}>Arborisis</span>`);
					} else return [createVNode(ApplicationLogo_default, { class: "block h-8 w-8 text-arbor-emerald shrink-0" }), createVNode("span", { class: "font-display text-lg font-semibold hidden sm:block" }, "Arborisis")];
				}),
				_: 1
			}, _parent));
			...
			_push(ssrRenderComponent(_sfc_main$4, {
				...
				trigger: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button type="button" class="${ssrRenderClass([_ctx.route().current("sounds.*") || _ctx.route().current("map.index") || _ctx.route().current("creators.*") ? "text-arbor-cream" : "", "inline-flex items-center px-3 py-2 text-sm font-medium leading-5 text-arbor-sage hover:text-arbor-cream transition duration-150 ease-in-out"])}"${_scopeId}> Explorer <svg class="-me-0.5 ms-1 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"${_scopeId}><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"${_scopeId}></path></svg></button>`);
					else return [createVNode("button", {
						type: "button",
						class: ["inline-flex items-center px-3 py-2 text-sm font-medium leading-5 text-arbor-sage hover:text-arbor-cream transition duration-150 ease-in-out", _ctx.route().current("sounds.*") || _ctx.route().current("map.index") || _ctx.route().current("creators.*") ? "text-arbor-cream" : ""]
					...
					if (_push) {
						...
						_push(ssrRenderComponent(_sfc_main$3, { href: _ctx.route("map.index") }, {
							default: withCtx((_, _push, _parent, _scopeId) => {
								...
								})])), createTextVNode(" Carte sonore ")])];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(ssrRenderComponent(_sfc_main$3, { href: _ctx.route("<redacted>-map.index") }, {
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<span class="flex items-center gap-2"${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"${_scopeId}></path></svg> Carte Arborisis </span>`);
								else return [createVNode("span", { class: "flex items-center gap-2" }, [(openBlock(), createBlock("svg", {
									class: "w-4 h-4",
									fill: "none",
									stroke: "currentColor",
								...
								})])), createTextVNode(" Carte Arborisis ")])];
							}),
							_: 1
						}, _parent, _scopeId));
					} else return [
			...
			_push(ssrRenderComponent(_sfc_main$4, {
				...
				content: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						createVNode("div", { class: "px-4 py-2" }, [createVNode(_sfc_main$5)]),
						createVNode("div", { class: "border-t border-arbor-glass-border my-1" }),
			...
			_push(`</div></div><div class="-me-2 flex items-center sm:hidden"><button${ssrRenderAttr("aria-label", showingNavigationDropdown.value ? "Fermer le menu" : "Ouvrir le menu")}${ssrRenderAttr("aria-expanded", showingNavigationDropdown.value)} class="inline-flex items-center justify-center rounded-xl p-2 text-arbor-sage transition duration-150 ease-in-out hover:bg-arbor-glass hover:text-arbor-cream focus:bg-arbor-glass focus:text-arbor-cream focus:outline-none"><svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24"><path class="${ssrRenderClass({
