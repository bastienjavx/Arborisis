		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_sfc_main$4, {
				...
				content: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
					...
					} else return [createVNode(_sfc_main$3, { href: _ctx.route("sounds.index") }, {
						...
						_: 1
					}, 8, ["href"]), createVNode(_sfc_main$3, { href: _ctx.route("map.index") }, {
						default: withCtx(() => [createVNode("span", { class: "flex items-center gap-2" }, [(openBlock(), createBlock("svg", {
							class: "w-4 h-4",
							fill: "none",
							stroke: "currentColor",
			...
			_push(ssrRenderComponent(_sfc_main$4, {
				...
				content: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="border-t border-arbor-glass-border my-1"${_scopeId}></div>`);
