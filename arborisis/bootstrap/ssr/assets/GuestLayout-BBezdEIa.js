import { t as ApplicationLogo_default } from "./ApplicationLogo-tPUvX9wY.js";
	...
	function play(sound = null, options = {}) {
		...
		if (sound) {
			if (currentSound.value?.id === sound.id) {
				...
				if (options.direct) requestNativePlay(sound);
				return;
			}
...
var _sfc_main = {
	...
	setup(__props) {
		...
		function handleClickOutside(event) {
			if (moreDropdownContainer.value && !moreDropdownContainer.value.contains(event.target)) showingMoreDropdown.value = false;
		}
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-arbor-night text-arbor-cream" }, _attrs))}><nav class="${ssrRenderClass([isScrolled.value ? "bg-arbor-forest/84 backdrop-blur-xl border-b border-arbor-mineral/10 h-14 shadow-[0_10px_50px_rgba(0,0,0,0.22)]" : "bg-transparent h-16", "fixed top-0 left-0 right-0 z-fixed-nav transition-all duration-300"])}"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full"><div class="flex items-center justify-between h-full">`);
			_push(ssrRenderComponent(unref(Link), {
				href: "/",
			...
			_push(`<div class="hidden md:flex items-center gap-1 rounded-full border border-arbor-mineral/10 bg-arbor-ink/25 px-1.5 py-1 backdrop-blur-xl">`);
			_push(ssrRenderComponent(unref(Link), {
				href: "/sounds",
				class: "nav-link px-3 py-2 rounded-full text-sm text-arbor-sage hover:text-arbor-cream hover:bg-arbor-mist/5 transition-colors cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-arbor-firefly/50 focus-visible:ring-offset-2 focus-visible:ring-offset-arbor-night"
			}, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(` Sons `);
			...
			_push(`<div class="relative"><button class="nav-link px-3 py-2 rounded-full text-sm text-arbor-sage hover:text-arbor-cream hover:bg-arbor-mist/5 transition-colors inline-flex items-center gap-1 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-arbor-firefly/50 focus-visible:ring-offset-2 focus-visible:ring-offset-arbor-night" aria-haspopup="true"${ssrRenderAttr("aria-expanded", showingMoreDropdown.value)}> Plus <svg class="${ssrRenderClass([showingMoreDropdown.value ? "rotate-180" : "", "w-3 h-3 transition-transform"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>`);
			if (showingMoreDropdown.value) {
				_push(`<div class="absolute right-0 mt-2 w-52 bg-arbor-forest/95 backdrop-blur-xl border border-arbor-mineral/10 rounded-xl shadow-xl py-1 z-dropdown">`);
				_push(ssrRenderComponent(unref(Link), {
					href: "/blog",
					class: "block px-4 py-2 text-sm text-arbor-sage hover:text-arbor-cream hover:bg-arbor-glass transition-colors cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-arbor-emerald/50 focus-visible:ring-offset-2 focus-visible:ring-offset-arbor-night"
				}, {
					default: withCtx((_, _push, _parent, _scopeId) => {
			...
			_push(`</div><div class="w-px h-5 bg-arbor-mineral/10 mx-2"></div>`);
			if (_ctx.$page.props.auth.user) _push(ssrRenderComponent(unref(Link), {
				...
				_push(ssrRenderComponent(unref(Link), {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(` Contribuer `);
						else return [createTextVNode(" Contribuer ")];
					}),
					_: 1
				}, _parent));
				_push(`<!--]-->`);
			...
			_push(`</div><div class="flex items-center md:hidden"><button${ssrRenderAttr("aria-label", showingMobileMenu.value ? "Fermer le menu" : "Ouvrir le menu")}${ssrRenderAttr("aria-expanded", showingMobileMenu.value)} class="inline-flex items-center justify-center rounded-xl p-2.5 text-arbor-sage transition duration-150 ease-in-out hover:bg-arbor-glass hover:text-arbor-cream focus:outline-none min-h-[44px] min-w-[44px]"><svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24"><path class="${ssrRenderClass({
				...
				hidden: !showingMobileMenu.value
			}, "md:hidden bg-arbor-forest/96 backdrop-blur-xl border-b border-arbor-mineral/10"])}"><div class="space-y-1 pb-3 pt-2 px-4">`);
			_push(ssrRenderComponent(unref(Link), {
				href: "/sounds",
			...
			_push(`<footer class="relative overflow-hidden border-t border-arbor-mineral/10 bg-arbor-ink"><div class="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_18%_0%,rgba(215,180,106,0.12),transparent_26rem),radial-gradient(circle_at_86%_12%,rgba(143,230,193,0.07),transparent_24rem)]"></div><div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14"><div class="grid grid-cols-1 gap-10 md:grid-cols-[1.4fr_0.8fr_0.8fr]"><div><div class="flex items-center mb-4">`);
			_push(ssrRenderComponent(ApplicationLogo_default, { class: "h-12 w-auto shrink-0" }, null, _parent));
			_push(`</div><p class="atlas-kicker mb-3">Le vivant s&#39;écoute</p><p class="text-arbor-sage text-sm max-w-md leading-relaxed mb-6"> Arborisis est un atlas acoustique pour écouter, documenter et préserver les traces sonores de la nature. </p><div class="max-w-sm"><h4 class="text-xs font-medium text-arbor-cream uppercase tracking-wider mb-3">Newsletter</h4>`);
			...
			_push(`</li><li>`);
			_push(ssrRenderComponent(unref(Link), {
				href: "/listening-points",
				class: "hover:text-arbor-emerald transition-colors"
			}, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`Points d&#39;écoute`);
					else return [createTextVNode("Points d'écoute")];
				}),
				_: 1
			}, _parent));
			_push(`</li><li>`);
			...
			_push(ssrRenderComponent(unref(Link), {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`API scientifique`);
					else return [createTextVNode("API scientifique")];
				}),
				_: 1
			}, _parent));
			_push(`</li><li>`);
