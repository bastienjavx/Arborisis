							...
							createVNode("div", null, [
								...
								createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-3 gap-3" }, [(openBlock(), createBlock(Fragment, null, renderList(types, (t) => {
									return createVNode("button", {
										...
										class: ["text-left p-4 rounded-xl border transition-all duration-200", unref(form).type === t.value ? "border-arbor-emerald bg-arbor-emerald/10 text-arbor-emerald" : "border-arbor-glass-border bg-arbor-glass/30 text-arbor-sage hover:bg-white/10"]
