import { t as _sfc_main$6 } from "./AuthenticatedLayout-C3aZldG3.js";
...
var _sfc_main$2 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`</div>`);
			if (totalCount.value > 0) _push(`<div class="mb-6"><div class="h-1.5 bg-arbor-charcoal rounded-full overflow-hidden"><div class="h-full bg-gradient-to-r from-arbor-emerald to-arbor-moss rounded-full transition-all duration-500 ease-out" style="${ssrRenderStyle({ width: `${progressPercentage.value}%` })}"></div></div></div>`);
			else _push(`<!---->`);
			if (loading.value && ideas.value.length === 0) {
				...
				ssrRenderList(ideas.value, (idea) => {
					...
					}, "group relative p-4 rounded-xl border transition-all duration-300"])}"><div class="flex items-start gap-3"><button class="${ssrRenderClass([{
					...
					}, "mt-0.5 shrink-0 w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all duration-200"])}"${ssrIncludeBooleanAttr(idea._processing) ? " disabled" : ""}>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (!statsAnimated.value) {
							...
							ssrRenderList(4, (n) => {
								_push(`<div class="stat-card"${_scopeId}><div class="flex items-center gap-3 mb-4"${_scopeId}><div class="w-10 h-10 rounded-xl bg-arbor-charcoal animate-pulse"${_scopeId}></div><div class="h-3 bg-arbor-charcoal rounded animate-pulse w-20"${_scopeId}></div></div><div class="h-8 bg-arbor-charcoal rounded animate-pulse w-16"${_scopeId}></div></div>`);
							});
							_push(`<!--]--></div>`);
						...
						_push(`</div></section><section class="pb-12 section-padding"${_scopeId}><div class="max-w-7xl mx-auto"${_scopeId}><div class="grid grid-cols-1 lg:grid-cols-3 gap-8"${_scopeId}><div class="lg:col-span-1"${_scopeId}>`);
						...
						_push(`</div></div></div></section><section class="pb-24 section-padding"${_scopeId}><div class="max-w-7xl mx-auto"${_scopeId}><div class="grid grid-cols-1 lg:grid-cols-3 gap-8"${_scopeId}><div class="lg:col-span-2 space-y-8"${_scopeId}>`);
						...
						createVNode("section", { class: "pb-12 section-padding" }, [createVNode("div", { class: "max-w-7xl mx-auto" }, [!statsAnimated.value ? (openBlock(), createBlock("div", {
							key: 0,
							...
							return createVNode("div", {
								key: n,
								class: "stat-card"
							}, [createVNode("div", { class: "flex items-center gap-3 mb-4" }, [createVNode("div", { class: "w-10 h-10 rounded-xl bg-arbor-charcoal animate-pulse" }), createVNode("div", { class: "h-3 bg-arbor-charcoal rounded animate-pulse w-20" })]), createVNode("div", { class: "h-8 bg-arbor-charcoal rounded animate-pulse w-16" })]);
						...
						createVNode("section", { class: "pb-12 section-padding" }, [createVNode("div", { class: "max-w-7xl mx-auto" }, [createVNode("div", { class: "grid grid-cols-1 lg:grid-cols-3 gap-8" }, [createVNode("div", { class: "lg:col-span-1" }, [createVNode(_sfc_main$5, {
							level: __props.gamification.level,
							"xp-total": __props.gamification.xp_total,
							"xp-for-next-level": __props.gamification.xp_for_next_level,
							"xp-progress": __props.gamification.xp_progress,
							...
							"medals-unlocked"
						])]), createVNode("div", { class: "lg:col-span-2" }, [createVNode(_sfc_main$4, { quests: __props.gamification.quests }, null, 8, ["quests"])])])])]),
						createVNode("section", { class: "pb-24 section-padding" }, [createVNode("div", { class: "max-w-7xl mx-auto" }, [createVNode("div", { class: "grid grid-cols-1 lg:grid-cols-3 gap-8" }, [createVNode("div", { class: "lg:col-span-2 space-y-8" }, [
							...
							}, [createVNode("p", { class: "text-arbor-sage text-sm" }, "Aucune activité récente à afficher.")]))])
