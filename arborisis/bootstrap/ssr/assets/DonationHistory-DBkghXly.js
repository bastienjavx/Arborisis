					...
					if (_push) {
						...
						if (activeTab.value === "sent") {
							...
							ssrRenderList(__props.sent.data, (donation, index) => {
								_push(`<div class="glass-card p-5 flex items-start gap-4 hover:bg-arbor-glass/50 transition-colors" style="${ssrRenderStyle(`animation: slideUp 0.4s ease-out forwards; animation-delay: ${index * .06}s; opacity: 0;`)}"${_scopeId}><div class="shrink-0"${_scopeId}>`);
