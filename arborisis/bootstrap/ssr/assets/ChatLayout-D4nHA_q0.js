import { t as _sfc_main$4 } from "./AuthenticatedLayout-BYUVvhyG.js";
import { t as _sfc_main$5 } from "./Modal-CRnUocqv.js";
					...
					if (_push) {
						...
						createVNode("div", null, [
							...
							withDirectives(createVNode("input", {
								...
								type: "text",
								class: "w-full rounded-lg bg-arbor-glass border border-arbor-glass-border px-3 py-2 text-arbor-cream text-base focus:outline-none focus:border-arbor-emerald/50",
								required: ""
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (isModerator.value) _push(`<button class="min-w-[44px] min-h-[44px] flex items-center justify-center text-arbor-sage hover:text-arbor-emerald" title="Créer un salon" aria-label="Créer un salon"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg></button>`);
			else _push(`<!---->`);
