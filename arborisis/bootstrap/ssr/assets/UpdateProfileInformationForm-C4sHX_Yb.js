import { n as _sfc_main$1, r as _sfc_main$3, t as _sfc_main$2 } from "./TextInput-ih5vh4Ub.js";
...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<textarea id="bio" rows="3" maxlength="1000" class="mt-1 block w-full rounded-lg border border-arbor-fog/30 bg-arbor-charcoal/50 px-4 py-2.5 text-sm text-arbor-cream placeholder:text-arbor-sage/40 focus:border-arbor-emerald/50 focus:outline-none focus:ring-1 focus:ring-arbor-emerald/20 transition-colors resize-none" placeholder="Parlez-nous de vous, de votre passion pour le field recording...">${ssrInterpolate(unref(form).bio)}</textarea>`);
			_push(ssrRenderComponent(_sfc_main$3, {
				class: "mt-2",
