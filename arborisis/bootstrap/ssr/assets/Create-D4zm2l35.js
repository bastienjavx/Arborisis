import { n as _sfc_main$1, r as _sfc_main$2, t as _sfc_main$3 } from "./TextInput-D3-qAvbf.js";
import { t as _sfc_main$4 } from "./AuthenticatedLayout-CVogD1xR.js";
import { Head, useForm } from "@inertiajs/vue3";
import { Fragment, createBlock, createCommentVNode, createTextVNode, createVNode, openBlock, ref, renderList, resolveComponent, toDisplayString, unref, useSSRContext, vModelCheckbox, vModelSelect, vModelText, withCtx, withDirectives, withModifiers } from "vue";
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_sfc_main$4, null, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="py-8"${_scopeId}><div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8"${_scopeId}><form class="space-y-8"${_scopeId}><div${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$1, { value: "Fichier audio *" }, null, _parent, _scopeId));
						...
						_push(`</div>`);
						_push(ssrRenderComponent(_sfc_main$2, { message: unref(form).errors.audio_file }, null, _parent, _scopeId));
						...
						_push(ssrRenderComponent(_sfc_main$2, { message: unref(form).errors.title }, null, _parent, _scopeId));
						_push(`</div><div${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$1, {
							for: "description",
							value: "Description"
						...
						_push(ssrRenderComponent(_sfc_main$2, { message: unref(form).errors.description }, null, _parent, _scopeId));
						...
						_push(ssrRenderComponent(_sfc_main$2, { message: unref(form).errors.latitude }, null, _parent, _scopeId));
						_push(`</div><div${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$1, {
							for: "longitude",
							value: "Longitude"
						...
						_push(ssrRenderComponent(_sfc_main$2, { message: unref(form).errors.longitude }, null, _parent, _scopeId));
						_push(`</div></div><button type="button" class="text-sm text-arbor-emerald hover:text-arbor-emerald-dark flex items-center gap-1 mb-4"${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"${_scopeId}></path></svg> Utiliser ma position actuelle </button><div class="grid grid-cols-1 sm:grid-cols-2 gap-4"${_scopeId}><div${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$1, {
							for: "location_name",
							value: "Nom du lieu"
						}, null, _parent, _scopeId));
						...
						_push(`<!--]--></select>`);
						_push(ssrRenderComponent(_sfc_main$2, { message: unref(form).errors.license }, null, _parent, _scopeId));
						_push(`</div><div${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$1, {
							for: "visibility",
							value: "Visibilité *"
						...
						_push(`<!--]--></select>`);
						_push(ssrRenderComponent(_sfc_main$2, { message: unref(form).errors.visibility }, null, _parent, _scopeId));
						_push(`</div></div><div${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$1, { value: "Image de couverture" }, null, _parent, _scopeId));
						...
						_push(`<button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="btn-primary disabled:opacity-50 disabled:cursor-not-allowed"${_scopeId}>`);
					...
					} else return [createVNode("div", { class: "py-8" }, [createVNode("div", { class: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8" }, [createVNode("form", {
						onSubmit: withModifiers(submit, ["prevent"]),
						class: "space-y-8"
					}, [
						createVNode("div", null, [
							createVNode(_sfc_main$1, { value: "Fichier audio *" }),
							createVNode("div", {
								...
								createVNode("p", { class: "text-xs text-arbor-sage/60" }, "MP3, WAV, FLAC, M4A — max 500 Mo")
							...
							createVNode(_sfc_main$2, { message: unref(form).errors.audio_file }, null, 8, ["message"])
						]),
						createVNode("div", null, [
							...
							createVNode(_sfc_main$2, { message: unref(form).errors.title }, null, 8, ["message"])
						]),
						createVNode("div", null, [
							createVNode(_sfc_main$1, {
								for: "description",
							...
							createVNode(_sfc_main$2, { message: unref(form).errors.description }, null, 8, ["message"])
						]),
						createVNode("div", { class: "glass-card p-6" }, [
							...
							createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4" }, [createVNode("div", null, [
								...
								createVNode(_sfc_main$2, { message: unref(form).errors.latitude }, null, 8, ["message"])
							]), createVNode("div", null, [
								createVNode(_sfc_main$1, {
									for: "longitude",
									value: "Longitude"
								...
								createVNode(_sfc_main$2, { message: unref(form).errors.longitude }, null, 8, ["message"])
							])]),
							createVNode("button", {
								type: "button",
							...
							})])), createTextVNode(" Utiliser ma position actuelle ")]),
							createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 gap-4" }, [createVNode("div", null, [createVNode(_sfc_main$1, {
								for: "location_name",
								value: "Nom du lieu"
							}), createVNode(_sfc_main$3, {
								id: "location_name",
						...
						createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 gap-6" }, [createVNode("div", null, [createVNode(_sfc_main$1, {
							for: "recorded_at",
							value: "Date d'enregistrement"
						}), createVNode(_sfc_main$3, {
							id: "recorded_at",
							...
							type: "date",
							class: "mt-2 block w-full"
						}, null, 8, ["modelValue", "onUpdate:modelValue"])]), createVNode("div", null, [createVNode(_sfc_main$1, {
							for: "recorded_time",
							value: "Heure d'enregistrement"
						}), createVNode(_sfc_main$3, {
							id: "recorded_time",
						...
						}), 128))], 8, ["onUpdate:modelValue"]), [[vModelSelect, unref(form).category_id]])]), createVNode("div", null, [createVNode(_sfc_main$1, {
							for: "environment_id",
							value: "Environnement"
						}), withDirectives(createVNode("select", {
							id: "environment_id",
						...
						createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 gap-6" }, [createVNode("div", null, [
							...
							createVNode(_sfc_main$2, { message: unref(form).errors.license }, null, 8, ["message"])
						]), createVNode("div", null, [
							createVNode(_sfc_main$1, {
								for: "visibility",
								value: "Visibilité *"
							...
							createVNode(_sfc_main$2, { message: unref(form).errors.visibility }, null, 8, ["message"])
						])]),
						createVNode("div", null, [
							createVNode(_sfc_main$1, { value: "Image de couverture" }),
							createVNode("div", { class: "mt-2" }, [
								...
								createVNode("label", { class: "inline-flex items-center px-4 py-2 rounded-xl border border-arbor-glass-border bg-arbor-glass text-sm text-arbor-cream cursor-pointer hover:bg-arbor-glass/50 transition-colors" }, [
									(openBlock(), createBlock("svg", {
										class: "w-4 h-4 mr-2",
										fill: "none",
										stroke: "currentColor",
							...
							createVNode(_sfc_main$2, { message: unref(form).errors.cover_image }, null, 8, ["message"])
						]),
						createVNode("div", { class: "flex items-center justify-end gap-4 pt-4 border-t border-arbor-glass-border" }, [createVNode(_component_Link, {
							href: "/sounds",
							class: "text-sm text-arbor-sage hover:text-arbor-cream transition-colors"
						}, {
						...
						}, [unref(form).processing ? (openBlock(), createBlock("span", { key: 0 }, "Publication en cours...")) : (openBlock(), createBlock("span", { key: 1 }, "Publier le son"))], 8, ["disabled"])])
					], 32)])])];
				}),
				_: 1
			}, _parent));
