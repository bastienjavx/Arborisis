...
import { n as _sfc_main$2, r as _sfc_main$4, t as _sfc_main$3 } from "./TextInput-BIuc15x0.js";
import { t as PrimaryButton_default } from "./PrimaryButton-CLE4nkEx.js";
import { Head, Link, useForm } from "@inertiajs/vue3";
import { createBlock, createCommentVNode, createTextVNode, createVNode, onMounted, openBlock, ref, toDisplayString, unref, useSSRContext, withCtx, withModifiers } from "vue";
import { ssrInterpolate, ssrRenderClass, ssrRenderComponent, ssrRenderStyle } from "vue/server-renderer";
			...
			_push(ssrRenderComponent(_sfc_main$1, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<form class="${ssrRenderClass([mounted.value ? "opacity-100" : "opacity-0", "space-y-5"])}" style="${ssrRenderStyle({ "transition": "opacity 0.6s ease-out 0.55s" })}"${_scopeId}><div class="${ssrRenderClass(mounted.value ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3")}" style="${ssrRenderStyle({ "transition": "all 0.5s ease-out 0.6s" })}"${_scopeId}>`);
						...
						_push(`</div><div class="${ssrRenderClass([mounted.value ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3", "flex items-center justify-between pt-2"])}" style="${ssrRenderStyle({ "transition": "all 0.5s ease-out 0.7s" })}"${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
							href: _ctx.route("login"),
							class: "text-sm text-arbor-sage hover:text-arbor-cream transition-colors"
						}, {
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(` Retour à la connexion `);
								else return [createTextVNode(" Retour à la connexion ")];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(ssrRenderComponent(PrimaryButton_default, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) if (unref(form).processing) _push(`<span${_scopeId}>Envoi...</span>`);
								else _push(`<span${_scopeId}>Envoyer le lien</span>`);
								else return [unref(form).processing ? (openBlock(), createBlock("span", { key: 0 }, "Envoi...")) : (openBlock(), createBlock("span", { key: 1 }, "Envoyer le lien"))];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(`</div></form></div><div class="${ssrRenderClass([mounted.value ? "opacity-100" : "opacity-0", "mt-6 text-center"])}" style="${ssrRenderStyle({ "transition": "opacity 0.5s ease-out 0.85s" })}"${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
							href: "/",
						...
						_push(`</div></div></div>`);
					} else return [createVNode(unref(Head), { title: "Mot de passe oublié" }), createVNode("div", { class: "relative min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden pt-16 py-12" }, [createVNode("div", { class: "absolute inset-0 overflow-hidden pointer-events-none" }, [
						createVNode("div", { class: ["absolute -top-40 -left-40 w-[500px] h-[500px] rounded-full bg-arbor-moss/10 blur-[100px] transition-all duration-1000", mounted.value ? "opacity-100 scale-100" : "opacity-0 scale-90"] }, null, 2),
						createVNode("div", { class: ["absolute -bottom-40 -right-40 w-[600px] h-[600px] rounded-full bg-arbor-emerald/5 blur-[120px] transition-all duration-1000 delay-200", mounted.value ? "opacity-100 scale-100" : "opacity-0 scale-90"] }, null, 2),
						...
						createVNode("div", {
							...
							createVNode("h1", { class: "font-display text-3xl font-bold text-arbor-cream mb-2" }, " Mot de passe oublié ? "),
							createVNode("p", { class: "text-arbor-sage text-sm" }, " On vous aide à retrouver l'accès à votre compte ")
						], 2),
						createVNode("div", {
						...
						}, " Pas de souci. Indiquez-nous votre adresse e-mail et nous vous enverrons un lien de réinitialisation qui vous permettra de choisir un nouveau mot de passe. ", 2),
						...
						createVNode("form", {
							...
							class: ["flex items-center justify-between pt-2", mounted.value ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3"],
							style: { "transition": "all 0.5s ease-out 0.7s" }
						}, [createVNode(unref(Link), {
							href: _ctx.route("login"),
							class: "text-sm text-arbor-sage hover:text-arbor-cream transition-colors"
						}, {
							default: withCtx(() => [createTextVNode(" Retour à la connexion ")]),
							_: 1
						}, 8, ["href"]), createVNode(PrimaryButton_default, {
							class: { "opacity-50 cursor-wait": unref(form).processing },
							disabled: unref(form).processing
						}, {
							default: withCtx(() => [unref(form).processing ? (openBlock(), createBlock("span", { key: 0 }, "Envoi...")) : (openBlock(), createBlock("span", { key: 1 }, "Envoyer le lien"))]),
							_: 1
						}, 8, ["class", "disabled"])], 2)], 34)
					], 2), createVNode("div", {
						class: ["mt-6 text-center", mounted.value ? "opacity-100" : "opacity-0"],
						style: { "transition": "opacity 0.5s ease-out 0.85s" }
					}, [createVNode(unref(Link), {
						href: "/",
						class: "text-sm text-arbor-sage hover:text-arbor-cream transition-colors inline-flex items-center gap-1.5"
					}, {
