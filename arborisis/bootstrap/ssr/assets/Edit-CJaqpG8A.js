...
import _sfc_main$2 from "./DeleteUserForm-CoYZuUIH.js";
import _sfc_main$3 from "./UpdatePasswordForm-BP7TvzSR.js";
import _sfc_main$4 from "./UpdateProfileInformationForm-CirHYsla.js";
			...
			_push(ssrRenderComponent(_sfc_main$1, null, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						createVNode("div", { class: "glass-card p-6 sm:p-8" }, [createVNode(_sfc_main$4, {
							"must-verify-email": __props.mustVerifyEmail,
							status: __props.status,
							class: "max-w-xl"
						}, null, 8, ["must-verify-email", "status"])]),
						createVNode("div", { class: "glass-card p-6 sm:p-8" }, [createVNode(_sfc_main$3, { class: "max-w-xl" })]),
