	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<button${ssrRenderAttrs(mergeProps({
				...
				class: ["rounded-lg font-medium transition-colors disabled:opacity-50", [sizeClasses[__props.size], following.value ? "bg-arbor-glass text-arbor-sage hover:bg-white/10 border border-arbor-glass" : "bg-arbor-emerald text-arbor-night hover:bg-arbor-emerald-dark"]]
