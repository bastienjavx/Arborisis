				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (filteredSounds.value.length > 0) {
							...
							ssrRenderList(filteredSounds.value, (sound, index) => {
								_push(ssrRenderComponent(unref(Link), {
									...
									class: "glass-card overflow-hidden hover:bg-white/10 transition-colors duration-300 group hover-lift",
						...
						createVNode("div", { class: "flex flex-wrap gap-2 mb-8" }, [createVNode("button", {
							...
							class: ["px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200", selectedCategory.value === "" ? "bg-arbor-emerald/15 text-arbor-emerald border border-arbor-emerald/30 shadow-sm shadow-arbor-emerald/5" : "bg-arbor-glass text-arbor-sage hover:bg-white/10 border border-transparent"]
							...
							return openBlock(), createBlock("button", {
								...
								class: ["px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200", selectedCategory.value === category.id ? "bg-arbor-emerald/15 text-arbor-emerald border border-arbor-emerald/30 shadow-sm shadow-arbor-emerald/5" : "bg-arbor-glass text-arbor-sage hover:bg-white/10 border border-transparent"]
