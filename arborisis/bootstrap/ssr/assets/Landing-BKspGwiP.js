import { n as usePlayerStore, t as _sfc_main$5 } from "./GuestLayout-CqMC9M4d.js";
...
var _sfc_main$2 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div class="absolute inset-0 bg-gradient-to-t from-arbor-night/80 via-transparent to-transparent"></div><button${ssrRenderAttr("aria-label", isPlaying.value ? `Mettre en pause ${__props.sound.title}` : `Lire ${__props.sound.title}`)} class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer"><div class="w-14 h-14 rounded-full bg-arbor-emerald/90 hover:bg-arbor-emerald flex items-center justify-center shadow-lg shadow-arbor-emerald/20 transition-all duration-200 active:scale-95 hover:scale-105">`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						ssrRenderList(categories.value, (cat) => {
							_push(`<span class="${ssrRenderClass([cat.color, "px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 hover:scale-105 cursor-pointer select-none"])}"${_scopeId}>${ssrInterpolate(cat.name)}</span>`);
						});
						_push(`<!--]--></div>`);
						_push(ssrRenderComponent(unref(Link), {
							href: "/map",
						...
						_push(ssrRenderComponent(_sfc_main$3, { class: "absolute inset-0 z-0" }, null, _parent, _scopeId));
						...
						createVNode("section", { class: "py-24" }, [createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
							...
							}, [createVNode("h2", { class: "font-display text-3xl sm:text-4xl font-bold text-arbor-cream mb-4" }, " Écoutez avant d'explorer "), createVNode("p", { class: "text-arbor-sage max-w-xl mx-auto" }, " Une sélection de sons récents pour vous transporter immédiatement dans la nature. ")], 4),
						...
						createVNode("section", { class: "py-24 bg-arbor-deep/30" }, [createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [createVNode("div", { class: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" }, [createVNode("div", null, [
							...
							createVNode("div", { class: "flex flex-wrap gap-3 mb-8" }, [(openBlock(true), createBlock(Fragment, null, renderList(categories.value, (cat) => {
								return openBlock(), createBlock("span", {
									key: cat.name,
									class: ["px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 hover:scale-105 cursor-pointer select-none", cat.color]
						...
						createVNode("section", {
							...
							createVNode(_sfc_main$3, { class: "absolute inset-0 z-0" }),
