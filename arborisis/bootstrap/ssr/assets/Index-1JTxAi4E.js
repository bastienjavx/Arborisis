								...
								_push(ssrRenderComponent(unref(Link), {
									...
									default: withCtx((_, _push, _parent, _scopeId) => {
										if (_push) {
											...
											if (getAvatarUrl(creator)) _push(`<div class="w-16 h-16 rounded-2xl overflow-hidden bg-arbor-deep"${_scopeId}><img${ssrRenderAttr("src", getAvatarUrl(creator))} class="w-full h-full object-cover" loading="lazy"${ssrRenderAttr("alt", creator.name)}${_scopeId}></div>`);
