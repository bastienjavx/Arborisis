				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						createVNode("div", { class: "flex flex-wrap gap-2 mb-8" }, [createVNode("button", {
							...
							class: ["px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200", selectedCategory.value === "" ? "bg-arbor-emerald/15 text-arbor-emerald border border-arbor-emerald/30 shadow-sm shadow-arbor-emerald/5" : "bg-arbor-glass text-arbor-sage hover:bg-arbor-glass/50 border border-transparent"]
							...
							return openBlock(), createBlock("button", {
								...
								class: ["px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200", selectedCategory.value === category.id ? "bg-arbor-emerald/15 text-arbor-emerald border border-arbor-emerald/30 shadow-sm shadow-arbor-emerald/5" : "bg-arbor-glass text-arbor-sage hover:bg-arbor-glass/50 border border-transparent"]
