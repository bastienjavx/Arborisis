...
var _sfc_main = {
	...
	setup(__props) {
		const SoundMap = defineAsyncComponent(() => import("./SoundMap-ChhROpbE.js"));
		const props = __props;
		const sounds = ref([]);
			...
			_push(ssrRenderComponent(_sfc_main$1, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`</div></div><div class="px-4 py-3 border-b border-arbor-glass-border animate-fade-in-up stagger-1"${_scopeId}><div class="flex flex-wrap gap-1.5"${_scopeId}><button class="${ssrRenderClass(["px-3 py-2 min-h-[44px] rounded-lg text-xs font-medium transition-colors duration-200 flex items-center", selectedCategory.value === "" ? "bg-arbor-emerald/15 text-arbor-emerald border border-arbor-emerald/30 shadow-sm shadow-arbor-emerald/5" : "bg-arbor-charcoal/60 text-arbor-sage border border-arbor-fog/40 hover:border-arbor-sage/50 hover:bg-arbor-charcoal"])}"${_scopeId}> Tous </button><!--[-->`);
						...
						createVNode("div", {
							...
							createVNode("div", { class: "px-4 py-3 border-b border-arbor-glass-border animate-fade-in-up stagger-1" }, [createVNode("div", { class: "flex flex-wrap gap-1.5" }, [createVNode("button", {
								class: ["px-3 py-2 min-h-[44px] rounded-lg text-xs font-medium transition-colors duration-200 flex items-center", selectedCategory.value === "" ? "bg-arbor-emerald/15 text-arbor-emerald border border-arbor-emerald/30 shadow-sm shadow-arbor-emerald/5" : "bg-arbor-charcoal/60 text-arbor-sage border border-arbor-fog/40 hover:border-arbor-sage/50 hover:bg-arbor-charcoal"],
