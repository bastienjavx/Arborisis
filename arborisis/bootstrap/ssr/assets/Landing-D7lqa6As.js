...
import { Fragment, createBlock, createTextVNode, createVNode, defineAsyncComponent, onMounted, onUnmounted, openBlock, ref, renderList, toDisplayString, unref, useSSRContext, withCtx } from "vue";
			...
			_push(ssrRenderComponent(_sfc_main$1, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						})}"${_scopeId}></div><div class="absolute inset-0 bg-hero-glow opacity-40"${_scopeId}></div><div class="absolute inset-0 overflow-hidden"${_scopeId}><!--[-->`);
						ssrRenderList(particles.value, (particle) => {
							_push(`<div class="${ssrRenderClass([`bg-${particle.color}/${particle.color === "arbor-sage" ? "20" : "30"}`, "absolute rounded-full animate-pulse-slow"])}" style="${ssrRenderStyle({
						...
						ssrRenderList(features.value, (feature, index) => {
							_push(`<div class="${ssrRenderClass([`stagger-${index + 1}`, "glass-card p-8 hover:bg-arbor-glass/50 transition-all duration-300 group hover-lift"])}" style="${ssrRenderStyle({
						...
						createVNode("section", { class: "relative min-h-screen flex items-center justify-center overflow-hidden" }, [
							...
							createVNode("div", { class: "absolute inset-0 overflow-hidden" }, [(openBlock(true), createBlock(Fragment, null, renderList(particles.value, (particle) => {
								return openBlock(), createBlock("div", {
									key: particle.id,
									class: ["absolute rounded-full animate-pulse-slow", `bg-${particle.color}/${particle.color === "arbor-sage" ? "20" : "30"}`],
									style: {
										width: `${particle.size}px`,
										height: `${particle.size}px`,
										left: `${particle.left}%`,
						...
						createVNode("section", { class: "py-24" }, [createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [createVNode("div", { class: "text-center mb-16" }, [createVNode("h2", { class: "font-display text-3xl sm:text-4xl font-bold text-arbor-cream mb-4" }, " Une expérience sonore unique "), createVNode("p", { class: "text-arbor-sage max-w-xl mx-auto" }, " Arborisis combine cartographie interactive, lecture haute-fidélité et communauté passionnée. ")]), createVNode("div", { class: "grid grid-cols-1 md:grid-cols-3 gap-8" }, [(openBlock(true), createBlock(Fragment, null, renderList(features.value, (feature, index) => {
							return openBlock(), createBlock("div", {
								key: feature.title,
								class: ["glass-card p-8 hover:bg-arbor-glass/50 transition-all duration-300 group hover-lift", `stagger-${index + 1}`],
								style: {
									"animation": "fadeInUp 0.6s ease-out forwards",
									"animation-delay": "${index * 0.15}s",
									"opacity": "0"
