...
import { createBlock, createTextVNode, createVNode, onMounted, openBlock, ref, unref, useSSRContext, withCtx, withModifiers } from "vue";
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(_sfc_main$1, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(unref(Head), { title: "Rejoindre" }, null, _parent, _scopeId));
						...
						_push(`</div><div class="${ssrRenderClass(mounted.value ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3")}" style="${ssrRenderStyle({ "transition": "all 0.5s ease-out 0.7s" })}"${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(ssrRenderComponent(PrimaryButton_default, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) if (unref(form).processing) _push(`<span${_scopeId}>Création du compte...</span>`);
								else _push(`<span${_scopeId}>Créer un compte</span>`);
								else return [unref(form).processing ? (openBlock(), createBlock("span", { key: 0 }, "Création du compte...")) : (openBlock(), createBlock("span", { key: 1 }, "Créer un compte"))];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(`</div></form><div class="${ssrRenderClass([mounted.value ? "opacity-100" : "opacity-0", "relative my-6"])}" style="${ssrRenderStyle({ "transition": "opacity 0.5s ease-out 0.8s" })}"${_scopeId}><div class="absolute inset-0 flex items-center"${_scopeId}><div class="w-full border-t border-arbor-glass-border"${_scopeId}></div></div><div class="relative flex justify-center text-xs"${_scopeId}><span class="bg-[#111827] px-3 text-arbor-sage/60"${_scopeId}>ou</span></div></div><div class="${ssrRenderClass([mounted.value ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3", "text-center"])}" style="${ssrRenderStyle({ "transition": "all 0.5s ease-out 0.85s" })}"${_scopeId}><p class="text-sm text-arbor-sage"${_scopeId}> Déjà membre ? `);
						...
						_push(`</p></div></div><div class="${ssrRenderClass([mounted.value ? "opacity-100" : "opacity-0", "mt-6 text-center"])}" style="${ssrRenderStyle({ "transition": "opacity 0.5s ease-out 0.95s" })}"${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
							href: "/",
						...
						_push(`</div></div></div>`);
					} else return [createVNode(unref(Head), { title: "Rejoindre" }), createVNode("div", { class: "relative min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden pt-16 py-12" }, [createVNode("div", { class: "absolute inset-0 overflow-hidden pointer-events-none" }, [
						...
						createVNode("div", {
							...
							createVNode("h1", { class: "font-display text-3xl font-bold text-arbor-cream mb-2" }, " Rejoindre Arborisis "),
							createVNode("p", { class: "text-arbor-sage text-sm" }, " Créez votre compte pour partager les sons de la nature ")
						], 2),
						createVNode("form", {
							onSubmit: withModifiers(submit, ["prevent"]),
							class: ["space-y-4", mounted.value ? "opacity-100" : "opacity-0"],
							...
							createVNode("div", {
								...
								default: withCtx(() => [unref(form).processing ? (openBlock(), createBlock("span", { key: 0 }, "Création du compte...")) : (openBlock(), createBlock("span", { key: 1 }, "Créer un compte"))]),
								_: 1
							}, 8, ["class", "disabled"])], 2)
						], 34),
						createVNode("div", {
						...
						}, [createVNode("div", { class: "absolute inset-0 flex items-center" }, [createVNode("div", { class: "w-full border-t border-arbor-glass-border" })]), createVNode("div", { class: "relative flex justify-center text-xs" }, [createVNode("span", { class: "bg-[#111827] px-3 text-arbor-sage/60" }, "ou")])], 2),
						createVNode("div", {
							class: ["text-center", mounted.value ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3"],
							style: { "transition": "all 0.5s ease-out 0.85s" }
						}, [createVNode("p", { class: "text-sm text-arbor-sage" }, [createTextVNode(" Déjà membre ? "), createVNode(unref(Link), {
							href: _ctx.route("login"),
							class: "text-arbor-emerald hover:text-arbor-emerald-dark font-medium transition-colors hover:underline underline-offset-4 ml-1"
						}, {
							default: withCtx(() => [createTextVNode(" Se connecter ")]),
							_: 1
						}, 8, ["href"])])], 2)
					], 2), createVNode("div", {
						class: ["mt-6 text-center", mounted.value ? "opacity-100" : "opacity-0"],
						style: { "transition": "opacity 0.5s ease-out 0.95s" }
