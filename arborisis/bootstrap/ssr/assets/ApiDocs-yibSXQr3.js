...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<!--]--></div><div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4"><div class="rounded-xl border border-arbor-glass-border bg-arbor-deep/35 p-4"><h4 class="text-sm font-semibold text-arbor-cream mb-2">Format</h4><p class="text-sm text-arbor-sage">Réponses JSON sous la clé <code class="text-arbor-cream">data</code>, prêtes pour notebooks, scripts ou dashboards.</p></div><div class="rounded-xl border border-arbor-glass-border bg-arbor-deep/35 p-4"><h4 class="text-sm font-semibold text-arbor-cream mb-2">Confidentialité</h4><p class="text-sm text-arbor-sage">Les coordonnées publiques sont approximées et les lieux sensibles ne sont jamais exposés précisément.</p></div><div class="rounded-xl border border-arbor-glass-border bg-arbor-deep/35 p-4"><h4 class="text-sm font-semibold text-arbor-cream mb-2">Limites</h4><p class="text-sm text-arbor-sage">L&#39;endpoint raw-data accepte <code class="text-arbor-cream">limit</code> avec un maximum serveur de 1000 lignes.</p></div></div></div>`);
		};
	}
};
